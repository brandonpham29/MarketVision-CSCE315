...
function Intrinsic() {
  ...
  const [targetPrice, setPrice] = useState("");
  ...
  const handleColors = (e) => {
    if (e.target.value == "Standard color vision") {
      ...
      setColor3(String(blinder.protanopia("green")));
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        ...
        {(marginQ > 0 || expectedQ > 0) && (
          ...
          data={[
            ...
            {
              x: days,
              y: Array(253).fill(Number(targetPrice)),
